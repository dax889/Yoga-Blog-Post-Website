    ...
    <div className="w-full">
      ...
      <section className="relative h-[70vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center max-w-3xl px-6">
          ...
          <p className="text-lg text-gray-200">
            Accessible yoga, mindful living, and modern wellness for real people in 2026.
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <p className="text-gray-700 leading-relaxed">
            ...
            <span className="font-semibold text-[#3a5a40]">
              Help modern humans find calm, strength, and balance — one practice at a time.
            </span>
          </p>

          <div className="bg-[#edf3ee] p-8 rounded-2xl">
            <h3 className="font-semibold text-lg mb-4">✨ My Mission for 2026</h3>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <blockquote className="bg-[#edf3ee] p-6 rounded-xl">
            <p className="text-sm text-gray-700">
              “These short practices changed how I handle stress at work.”
            </p>
            <span className="block mt-3 text-xs font-semibold">— Corporate Professional</span>
          </blockquote>
          ...
          <blockquote className="bg-[#edf3ee] p-6 rounded-xl">
            ...
            <span className="block mt-3 text-xs font-semibold">— Wellness Student</span>
          </blockquote>
